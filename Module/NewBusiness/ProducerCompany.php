                ...
                <div class="card border-0" id="paragraph">
                    ...
                    <section>
                        ...
                        <ul>
                            ...
                            <li>Processing and packaging produce to add value.</li>
                            <li>Providing equipment, training, technical services, and consultancy.</li>
                        ...
                        <ul>
                            ...
                            <li>Limited liability and professional management structure.</li>
                            <li>Minimal capital requirement (Rs. 1 lakh paid-up, Rs. 5 lakh authorised).</li>
                        ...
                        <ol>
                            ...
                            <li><strong>Name Reservation:</strong> Submit Form SPICe+ with two name choices.</li>
                            <li><strong>Prepare Documents:</strong> MoA, AoA, office address proof, affidavits, and
                                director appointment forms.</li>
                            <li><strong>File Incorporation Application:</strong> Submit SPICe+ with the ROC.</li>
                        ...
                        <ul>
                            ...
                            <li>Annual returns and board meetings.</li>
