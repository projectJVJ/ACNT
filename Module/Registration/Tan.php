            ...
            <div class="col-md-12 col1 p-3 ps-4 mt-5 height-fit-content main-container-border-radius">
                <div class="card border-0" id="paragraph">
                    ...
                    <p>Simplify Tax Deduction Compliance with Easy TAN Registration from Hiva
                        Professionals</p>
                    <h4>What is TAN?</h4>
                    <p>TAN (Tax Deduction and Collection Account Number) is a 10-digit alphanumeric identifier
                        issued under Section 203A of the Income Tax Act, 1961. It is used for TDS return filing,
                    ...
                    <ul>
                        ...
                        <li>E-commerce platforms deducting TDS on seller payments</li>
                        <li>Companies collecting TCS (e.g., scrap dealers, alcohol distributors)</li>
                        <li>Startups or freelancers paying consultants or vendors</li>
                    </ul>
                    ...
                    <ul>
                        <li>PAN Card of the entity or proprietor</li>
                        <li>Certificate of Incorporation / Partnership Deed</li>
                        <li>Business Address Proof</li>
                        <li>Authorized Signatory’s ID Proof</li>
                    ...
                    <h4>Track Your TAN Status</h4>
                    <p>Applicants can track the TAN application using the acknowledgment number on the <a
