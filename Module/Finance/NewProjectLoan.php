        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-5 ps-3 first-card p-0">
                        <div class="card border-0">
                            <img src="/acnt/assets/img/cc_od_limits.png" height="" width="" class="card-img-top rounded-lg w-90" alt="New Project Loan_img">
            ...
            <div class="col-md-12 p-3 mt-5 main-container-border-radius">
                <div class="card border-0" id="paragraph">
                    <h3 class="mb-4 text-center">New Project Loan – Empower Your Business Vision</h3>

                    <p>
                        A <strong>New Project Loan</strong> is a financial instrument designed to provide the necessary capital for starting a new business venture, expanding operations, or launching an ambitious project. Whether you're establishing a manufacturing unit, opening a service center, or entering a new market, project loans offer the critical funding required to bring your vision to life.
                    </p>

                    <p>
                        These loans are tailored to meet specific project requirements, covering land purchase, infrastructure development, machinery acquisition, manpower hiring, and working capital needs. The process involves detailed project evaluation to ensure viability, profitability, and timely repayment.
                    </p>
                    ...
                    <p class="mt-4">
                        At <strong>Hiva Professionals</strong>, we believe in transforming ideas into thriving ventures. Our expertise in finance and project management empowers entrepreneurs and businesses to bring their dreams to life through tailored project loan solutions. Contact us today and take the first step toward your next big success!
                    </p>
                </div>
            </div>
        </div>
