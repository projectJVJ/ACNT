...
<body>
    ...
    <div class="container-fluid mt-5 main-container">
        <div class="row p-3">
            <div class="col-md-8 col1 p-0">
                <div class="row">
                    <div class="col-md-4 first-card p-0">
                        <div class="card">
                            <img src="assets/img/services.jpg" class="card-img-top" alt="Partnership Registration">
                            <div class="card-body">
                                <ul>
                                    <li>Pan Card</li>
                                    <li>Aadhar Card</li>
                    ...
                    <div class="col-md-8 ps-5">
                        <div class="card">
                            ...
                            <p><span class="text-success fw-bold">4.3</span> 7596 Customers</p>
                            <p>Get your partnership firm deed drafted by our experts, along with firm PAN and GST registration.
                            </p>
            ...
            <div class="col-md-4 ps-5 col2">
                <div class="card border-0 rounded">
                    ...
                    <div class="card-body text-center">
                        <span class=" text-2sm text-gray-700"> Existing User?<a href="#" class="text-primary ps-3">LOGIN</a></span>
                    </div>
                ...
                <button class="btn btn-success w-100 mt-2">Get Started</button>
            </div>
        </div>
    </div>
    ...
    <div class="row col-md-12">
        <div class="col-md-8">
            <div class="card" id="paragraph">
                <h3 class=" text-center">Partnership Firm Registration</h3>
                <p class="text-align-justify">partnership firm is a popular choice among entrepreneurs due to its simplicity and flexibility. It
